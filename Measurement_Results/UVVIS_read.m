...
xlRange= 'A29:WD39'
zonder= xlsread(fullfile('UV-VIS','7.03.16','GNP_2.5_20k_2.xlsx'),'Zonder zout',xlRange);
met= xlsread(fullfile('UV-VIS','7.03.16','GNP_2.5_20k_2.xlsx'),'Met zout',xlRange);
x=zonder(1,:);
y1=zonder(2,:);
y2=zonder(3,:);
y3=zonder(4,:);
...
plot(x,y8,'LineWidth',2.5,'LineStyle','--','color',hex2rgb('BFAA13'))
...
plot(x,y18,'LineWidth',2.5,'LineStyle','-','color',hex2rgb('BFAA13'))

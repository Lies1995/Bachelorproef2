...
\begin{frame}[plain]
\vspace{7cm}
\tiny Source: Y. Connor et all. \emph{Nature Communications $2015$,\textbf{6}}
\end{frame}
...
\begin{frame}{Gel electrophoresis to analyse DNA damage}
    ...
    \vspace{5cm}
    \tiny Source: \url{https://www.quora.com/ Whats-the-difference-between-a-plasmid-and-a-virus.}
  \end{frame}

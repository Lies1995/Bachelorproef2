...
\begin{frame}{Find optimal PEG/GNP proportion}
      	\begin{overprint}
    		\only<1>{
				\vspace{0.4cm}
						\centering
						$1$. Add PEG and perform UV-Vis measurement
				\vspace{0.25cm}
        		\begin{figure}[tb]
            		\centering
    		...
    		\only<2>{
						\centering
						$2$. Add NaCl and perform UV-Vis measurement
        		\begin{figure}[tb]
            		\centering
...
\begin{frame}{Gel electrophoresis to analyse DNA damage}
  \vspace{0.5cm}
    ...
    \begin{figure}
      \centering
      \includegraphics[width=.6\textwidth]{gfx/GelElec.png}
    \end{figure}
    \vfill
		%\vspace{cm}
...
\column{0.2\textwidth}
  \begin{figure}[tb]
    \centering
    \includegraphics[width=\textwidth]{gfx/1kgel}
...
%  \end{itemize}
  ...
  \begin{figure}[tb]
    \centering
    \includegraphics[width=\textwidth]{gfx/gelref}
  \end{figure}
\end{columns}
\end{frame}
...
\begin{center}
    \begin{tabular}{@{}l@{}}
      \tabitem Radiosensitization effect was observed\\

...
\title[]{\small Bachelor Thesis 2016 \\ \vspace{0.2cm} \Huge Radiosensitization \\ using gold nanoparticles}
\author[]{Lies Deceuninck en Hannelore Verhoeven} % Your name
\date
...
\begin{frame}[plain]
\vspace{9.2cm}
\textcolor{white}{\tiny Source: Y. Connor et all. \emph{Nature Communications $2015$,\textbf{6}}}
...
%------------------------------------------------
    ...
    \vfill
    \vspace{0.6cm}
    \tiny Source: \url{https://chem.kuleuven.be/veiligheid/info/ioniserende-st.html}
...
\normalsize
    ...
    \vfill
    \vspace{0.7cm}
    \tiny Source: \url{https://en.wikibooks.org/wiki/Basic_Physics_of_Digital_Radiography/The_Patient}
\end{frame}
...
\begin{center}
\large Radiosensitization of DNA \\using gold nanoparticles
\end{center}
\begin{columns}[c]
\normalsize
...
\end{figure}
  ...
  \vfill
  \vspace{0.4cm}
  \tiny Source: A. Chaudhary et all. \emph{Phys. Chem. Chem. Phys., 2014 \textbf{16}}
\end{frame}
...
\begin{figure}[tb]
	\centering
	\includegraphics[width=0.9\textwidth]{gfx/Inhoud2}
\end{figure}
	\end{columns}
  \vfill
  \vspace{0.4cm}
...
\frametitle{PEG for targeting and stabilization}
    ...
    \begin{figure}[tb]
    	\centering
    	\includegraphics[width=0.4\textwidth]{gfx/PEG}
    \end{figure}
    \vspace{-.7cm}
   $\quad\qquad \qquad$ $\qquad \quad$ \qquad Polyethylene glycol
    %\vspace{1cm}
    \begin{columns}
    	\column{.5\textwidth}
    	\begin{figure}[tb]
...
\begin{frame}{Gel electrophoresis to analyse DNA damage}
    \begin{figure}
      \includegraphics[width=.8\textwidth]{gfx/schade.png}
    \end{figure}

    \begin{figure}
      \includegraphics[width=.7\textwidth]{gfx/GelEl.png}
    \end{figure}
    \vfill
		\vspace{.5cm}
    \tiny Sources: \url{https://www.quora.com/ Whats-the-difference-between-a-plasmid-and-a-virus.} \url{http://www.vce.bioninja.com.au/aos-3-heredity/molecular-biology-technique/dna-profiling.html}
  \end{frame}
...
\begin{frame}{Gel electrophoresis to analyse DNA damage}
  \vspace{1cm}
\begin{figure}
  \includegraphics[width=0.6\textwidth]{gfx/gel2}
\end{figure}
    \vfill
    \vspace{0.9cm}
    \tiny Source: Maunus R et al. Horton JR, Zhang X. Nucleic Acids Research, 34(3):939-948, 2006.
\end{frame}
\begin{frame}{DNA damage analysis}
  \vspace{2.05cm}
  \begin{figure}[b]
  \centering
    \includegraphics[width=\textwidth]{gfx/damage}
  \end{figure}
\end{frame}
...
\begin{frame}{DNA damage analysis}
    \centering
    \vspace{0.7cm}
    Reference sample has an unexpected form
    \vspace{0.8cm}
    \begin{figure}[b]
    \centering
      \includegraphics[width=\textwidth]{gfx/damage}
...
\begin{frame}{DNA damage analysis}
    \centering
    \vspace{0.7cm}
    Radiosensitization effect is present
    \vspace{0.8cm}
    \begin{figure}[b]
    \centering
      \includegraphics[width=\textwidth]{gfx/damage}
...
\begin{frame}{DNA damage analysis}
  \centering
    \vspace{0.4cm}
    Smaller PEG $\rightarrow$ more DNA damage\\
		Larger GNP $\rightarrow$ more DNA damage
    \vspace{0.615cm}
    \begin{figure}[b]
    \centering
      \includegraphics[width=\textwidth]{gfx/damage}
...
\column{0.7\textwidth}
\begin{itemize}
    \item \textcolor{lgray}{Strange results for $1$ k PEG}
    \item \textcolor{lgray}{Curves are not rising (except $30$ nm GNP)}
    \item Reference sample has strange form
		\item \textcolor{lgray}{DNA damage at $0$ Gy}
		\item \textcolor{lgray}{Radiosensitization effect}
		\item \textcolor{lgray}{Smaller PEG $\rightarrow$ more DNA damage}
		\item \textcolor{lgray}{Larger GNP $\rightarrow$ more DNA damage}
\end{itemize}
\column{0.2\textwidth}
  \begin{figure}[tb]
    \centering
...
\begin{center}
    \begin{tabular}{@{}l@{}}
      \tabitem Functionalization $1$k PEG strange behavior \\

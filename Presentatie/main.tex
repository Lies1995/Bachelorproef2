...
\begin{frame}
\footlineextra{Source: \url{http://www.interne.com.br/novidades/index.php?option=com_content&view=article&id=2714:cientista-brasileiro-analisa-efeitos-da-gravidade-zero-em-celulas-do-cancer&catid=26:saude&Itemid=3}}
\begin{columns}
\column{.5\textwidth}
\Large
Bachelor Thesis 2016\\
As. Bert De Roo, Mattias Vervaele, Stephanie Ser\'e
\column{.4\textwidth}
\end{columns}
...
%------------------------------------------------
	...
	\begin{frame}{Radiosensitization with GNP \footnotesize E $\sim$ keV}
	...
	\begin{frame}{Goal}
		...
		\footlineextra{Source: E. Bruna, L. Sancheb, C. Sicard-Roselli, \emph{Colloids and Surfaces B: Biointerfaces}, 2009, \textbf{72}}
...
%------------------------------------------------
	...
	\vspace{-1cm}
		\begin{columns}
			...
			\centering
			Laser Doppler Gel electrophoresis
			\begin{figure}[tb]
					\centering
	...
	\end{frame}
\begin{frame}[t]
\frametitle{Zeta Potential: Results}
    \vspace{0.5cm}
		\begin{figure}[tb]
    		\centering
...
\begin{frame}[t]
\frametitle{Functionalization PEG}

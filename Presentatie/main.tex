	...
	\vspace{-1cm}
		\begin{columns}
			\column{.6\textwidth}
				...
				\begin{figure}[tb]
    			\centering
    			\includegraphics[width=\textwidth]{gfx/zeta}
    			\end{figure}
			\column{.4\textwidth}
			\centering
...
\frametitle{Measurement Results}
    \vspace{0.5cm}
		\begin{figure}[tb]
    		\centering
    		\includegraphics[width=0.8\textwidth]{gfx/zetaRes}
    	\end{figure}
    \vspace{0.5cm}
    	\begin{columns}[c]
		\column{.5\textwidth}
...
\frametitle{Functionalisation PEG}
    \centering
    Electrical repulsion $\rightarrow$ Steric repulsion\\
    \begin{figure}[tb]
    	\centering
    ...
    \begin{columns}
    	...
    	\begin{figure}[tb]
    		\centering
    		\includegraphics[width=0.9\textwidth]{gfx/PEG2}
    	\end{figure}
    	\column{.5\textwidth}
    	\begin{figure}[tb]
    		\centering

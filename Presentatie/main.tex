...
\begin{frame}{GNP of different sizes}
\begin{figure}[tb]
            		\centering
...
\begin{frame}{15nm GNP with 20k PEG for different $\frac{V_{PEG}}{V_{GNP}}$}
      	\begin{overprint}
    		\only<1>{
        		\begin{figure}[tb]
            		\centering
...
%------------------------------------------------
	...
	\end{frame}
\subsection{Measurements Results}
\begin{frame}[t]
...
\begin{itemize}
    ...
    \item Characterisation with different techniques

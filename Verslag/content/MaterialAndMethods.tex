...
The analysis of the DNA damage is done using gel electrophoresis. With this technique it is possible to separate charged macromolecules based on their charge and size. The charged molecules that need to be separated are loaded into a well at one end of a gel. Thereafter a voltage is applied across the gel and the charged molecules move accordingly trough the gel. Small molecules and molecules with a large charge move faster trough the gel then larger molecules and molecules with a lower charge. Molecules with the same charge and size will travel the same distance trough and will collect into a band.

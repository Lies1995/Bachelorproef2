...
Because DNA is negatively charged, it is suitable for gel electrophoresis. Supercoiled DNA is the most compact and so has the highest mobility,  supercoiled DNA travels the largest distance in the gel. Circular DNA, due to a single strand break, has the lowest mobility and therefore travels the smallest distance trough the gel, due to its large expanse. Linear DNA which is a result of a double strand break travels an intermediate distance. \\

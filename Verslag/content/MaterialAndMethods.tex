...
A typical characterization technique of GNP is a measurement of the abosorbance spectrum in the ultra-violet and visible spectrum. The peak in the spectrum provides information about the core diameter of the particles. \\
\begin{figure}
  \includegrapics[width=0.8\textwidth]{gfx/plasmon}

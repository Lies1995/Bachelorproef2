...
\end{center}
        \caption{The region of dominance of the different interaction types in function of the atomic number of the absorber and the energy of the incoming photon \cite{dominant}.}
				\label{fig:dominant}
\end{figure}\\
...
\end{center}
        \caption{The attenuation length of X-rays in water as a function of incomminng photon enery \cite{atlength}.}
				\label{fig:atlength}
\end{figure}\\

...
\begin{wrapfigure}{r}{0.4\textwidth}
  ...
  \begin{subfigure}[t]{0.7\textwidth}
    \includegraphics[width=0.40\textwidth]{gfx/ptargeting}
    \caption{}
    \label{fig:ptargeting}
  \end{subfigure}
  \begin{subfigure}[t]{0.7\textwidth}
    \includegraphics[width=0.40\textwidth]{gfx/atargeting}
    \caption{}
    \label{fig:atargeting}
  \end{subfigure}
  \caption{Gold nanoparticles coated with (a) polyethylene glycol and (b) antibodies.}
\end{wrapfigure}
